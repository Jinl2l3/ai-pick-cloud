...
- 🖼️ **图片AI独立设置** - 图片分类提示词、重命名提示词、结构化输出提示词独立配置
- 🎥 **视频AI独立设置** - 视频分类提示词、重命名提示词、结构化输出提示词独立配置

## 效果展示

### 运行界面

<img src="doc/运行图.png" alt="运行界面" width="400" style="max-width: 50%; height: auto;">

### 设置页面

<img src="doc/设置页面1.png" alt="设置页面1" width="400" style="max-width: 50%; height: auto;">

<img src="doc/设置页面2.png" alt="设置页面2" width="400" style="max-width: 50%; height: auto;">

### 整理效果

#### 整理前

<img src="doc/整理前.png" alt="整理前" width="300" style="max-width: 50%; height: auto;">

#### 整理后

<img src="doc/整理后.png" alt="整理后" width="300" style="max-width: 50%; height: auto;">
...
- **网络 API 模型列表**: 支持配置多个模型进行轮询使用
- **启用模型轮询**: 开启/关闭多模型轮询功能，启用后会自动在多个模型间分配请求
- **单模型最大并发**: 每个模型的最大并发请求数，默认 2

### 图片AI 设置
- **分类提示词**: 图片分类的提示词模板，支持 `{categories}` 占位符
- **重命名提示词**: AI 生成图片描述的提示词
- **结构化输出提示词**: 自定义 JSON 输出格式约束，留空则使用默认值
- **启用重命名**: 是否启用图片文件重命名功能

### 视频AI 设置
- **分类提示词**: 视频分类的提示词模板，支持 `{categories}` 占位符
- **重命名提示词**: AI 生成视频描述的提示词
- **结构化输出提示词**: 自定义 JSON 输出格式约束，留空则使用默认值
- **启用重命名**: 是否启用视频文件重命名功能
